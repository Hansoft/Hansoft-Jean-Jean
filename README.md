...
All settings are described in detail in the settings file [JeanSettings.xml]. (Some link....)
...
Refer also to the detailed documentation of AbstractBehavior found in the [API Reference] (Some link....).
...
For detailed information about ObjectWrapper refer to the [ObjectWrapper API Reference] (Some link....).
